...
function SignIn() {
  ...
  return (
    <div className='parent flex items-center justify-center h-screen w-screen '>
      <div className='child font-bold text-[29px] h-1/4 w-1/2 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 flex  flex-col gap-4'>
        <div className='flex justify-center text-lg sm:text-base md:text-lg lg:text-xl xl:text-2xl'>Faça o login</div>
        <Input upText="Email" alertMsg="Senha incorreta" onChange={(e) => setEmail(e.target.value)}></Input>
